			...
			<div className="relative z-10 max-w-5xl mx-auto px-4">
				<div className="text-center space-y-6">
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						<div className="flex flex-col items-center gap-4">
							<div className="flex items-center gap-3">
								...
								<h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-400">AI Engineer</h2>
								<span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
							</div>
							<p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
								Crafting intelligent and impactful digital solutions with cutting-edge AI and modern web technologies.🤖💻
							</p>
						</div>

						{/* Tech Stack Pills */}
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['PyTorch', 'Deep Learning', 'Transformers', 'LLMs', 'Docker', 'FastAPI', 'Next.js'].map((tech) => (
								<span
									key={tech}
					...
					<div className="flex justify-center gap-4 sm:gap-6 mt-8 sm:mt-12">
						{[
							{ name: 'GitHub', icon: <Github/>, href: 'https://github.com/20-uday-06' },
							{ name: 'LinkedIn', icon: <Linkedin />, href: 'https://www.linkedin.com/in/uday-tyagi-455a76282/' },
							{ name: 'Twitter', icon: <Twitter />, href: 'https://x.com/uday_tyagi2006' },
							{ name: 'Instagram', icon: <Instagram />, href: 'https://www.instagram.com/udaytyagi2006/' },
						].map((social) => (
