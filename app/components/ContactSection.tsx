	...
	return (
		<section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				...
				<p className="text-sm sm:text-base text-gray-400 mb-6">Looking for a developer who talks to AI models by day, and thinks debugging is just supervised learning for humans? You’re in the right place!</p>
				...
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					<a
						href="mailto:uday_t@ce.iitr.ac.in"
				...
				<div className="flex justify-center gap-6">
					<a
						href="https://github.com/20-uday-06"
						target="_blank"
					...
					<a
						href="https://www.linkedin.com/in/uday-tyagi-455a76282/"
						target="_blank"
						rel="noopener noreferrer"
						className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
					>
					...
					<a
						href="https://x.com/uday_tyagi2006"
						target="_blank"
						rel="noopener noreferrer"
						className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
					>
